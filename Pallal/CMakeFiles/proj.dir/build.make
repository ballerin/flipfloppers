...
proj: /usr/local/lib/libopencv_superres.so.3.0.0
proj: /usr/local/lib/libopencv_stitching.so.3.0.0
proj: /usr/local/lib/libopencv_shape.so.3.0.0
proj: /usr/local/lib/libopencv_photo.so.3.0.0
proj: /usr/local/lib/libopencv_objdetect.so.3.0.0
proj: /usr/local/lib/libopencv_hal.a
proj: /usr/local/lib/libopencv_calib3d.so.3.0.0
proj: /usr/local/lib/libopencv_features2d.so.3.0.0
proj: /usr/local/lib/libopencv_ml.so.3.0.0
proj: /usr/local/lib/libopencv_highgui.so.3.0.0
proj: /usr/local/lib/libopencv_videoio.so.3.0.0
proj: /usr/local/lib/libopencv_imgcodecs.so.3.0.0
proj: /usr/local/lib/libopencv_flann.so.3.0.0
proj: /usr/local/lib/libopencv_video.so.3.0.0
proj: /usr/local/lib/libopencv_imgproc.so.3.0.0
proj: /usr/local/lib/libopencv_core.so.3.0.0
proj: /usr/local/lib/libopencv_hal.a
proj: /usr/local/share/OpenCV/3rdparty/lib/libippicv.a
